...
// Starting allocation as per instructions: Ind: 50, US: 20, Debt: 20, Gold: 10
...
export const SCENARIO_DATA: ScenarioRound[] = [
  {
    ...
    analyst: {
      bull: "Margins are expanding permanently. This is a structural re-rating of equities. We are witnessing the decoupling of revenue from headcount. Buy Tech aggressively.",
      bear: "Flat revenues mean no real organic growth. It's all financial engineering via cost-cutting. Who buys the products if everyone is shedding 'biological friction'? This isn't sustainable."
    },
  ...
  },
  {
    ...
    analyst: {
      bull: "Helicopter money! Stocks love liquidity. The consumer is being bailed out. Buy everything.",
      bear: "They are devaluing the currency to fund this. This is hyper-inflationary in the long run. Buying stocks is just hedging against currency collapse."
    },
  ...
  },
  {
    ...
    analyst: {
      bull: "Demand is back. Earnings estimates are being revised up 50%. Ignore the deficit; growth cures all.",
      bear: "Inflation is back with a vengeance. Bond yields will spike (prices fall) as the deficit explodes. The Fed is trapped."
    },
  ...
  },
  {
    ...
    analyst: {
      bull: "Equities are the only hedge against inflation. Companies can raise prices to match inflation. Bonds are dead money.",
      bear: "Stagflation is the worst of all worlds. High inflation + High Bond Yields = Equity P/E contraction. Gold is the only answer."
    },
  ...
  },
  {
    ...
    analyst: {
      bull: "The crisis is over. Real growth is replacing stimulus growth. Quality stocks will lead. The productivity boom is finally real.",
      bear: "Rate hike? In a fragile recovery? This might cause a double-dip recession. Proceed with caution."
    },
  ...
  },
  {
    ...
    analyst: {
      bull: "Long India, Neutral US. The growth differential is too massive to ignore. India is the new engine of global growth.",
      bear: "Global slowdown will eventually hit India. Don't chase hot money. Valuations in India are getting stretched."
    },
  ...
  },
  {
    ...
    analyst: {
      bull: "Goldilocks is back. A perfect setup for a multi-year bull run. Volatility is dead.",
      bear: "Fair value reached. Expect average returns, not lottery tickets. The easy money has been made."
    },
